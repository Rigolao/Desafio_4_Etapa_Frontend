      ...
      <div>
        ...
        <div className="blocoInfos">
          ...
          <div className="descricaoDireita">
            ...
            <p>
              Na SciLink você alcança seus objetivos, sem perde o foco,
              auxiliando<br></br> você a se concentrar no cerne do projeto. Não
              fique de fora dessa<br></br> comunidade incrível.
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="blocoInfos">
          <div className="descricaoEsquerda">
            ...
            <p>
              Na plataforma você pode realizar consulta nos perfis dos
              colaboradores, entender um<br></br> pouco sobre cada um, e
              visualizar seus post.
            </p>
          </div>
